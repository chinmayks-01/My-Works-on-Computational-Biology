...
def render_header_with_horizontal_dna():
    ...
    # Injected script with glowing particle effects
    dna_js = """
    <script>
    (function() {
        try {
            ...
            class DNAParticle {
                ...
                draw(ctx, pulse) {
                    ...
                    ctx.save();
                    ctx.globalCompositeOperation = 'lighter'; // Additive blending for intense bioluminescent glow

                    // Outer intense halo glow
